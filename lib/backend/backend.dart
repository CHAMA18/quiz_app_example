...
import 'schema/image_collection_record.dart';
...
export 'schema/image_collection_record.dart';
...
Stream<List<ImageCollectionRecord>> queryImageCollectionRecord(
        {Query Function(Query) queryBuilder,
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollection(
        ImageCollectionRecord.collection, ImageCollectionRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);
